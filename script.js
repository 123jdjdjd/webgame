...
function removeBlock(){
    blocks.forEach(block => {
        ...
        // if ball hits the block, the blockj will disappear
        if(blockPos.left < ballPos.right && blockPos.top < ballPos.bottom && blockPos.
            right > ballPos.left && blockPos.bottom > ballPos.top && !block.classList.contains
            ('remove')){
...
function collission(){
    ...
    // if ball touches the paddle, the ball wil jump
    if(paddlePos.left < ballPos.right && paddlePos.top < ballPos.bottom && paddlePos.
        right > ballPos.left && paddlePos.bottom > ballPos.top) {
